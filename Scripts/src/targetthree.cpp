...
// target three button of the game's target selection. It sends messages via
...
class TargetThreeScript : public IScript
{
public:
  TargetThreeScript()
  {
  ...
  void OnMouseStay() override
  {
    ...
    {
      Application::MessagingSystem::Send("TargetThree clicked", true);
    }
  }
...
static TargetThreeScript TargetThree;
