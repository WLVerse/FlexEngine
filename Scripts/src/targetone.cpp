...
// target one button of the game's target selection. It sends messages via
...
class TargetOneScript : public IScript
{
public:
  TargetOneScript()
  {
  ...
  void OnMouseStay() override
  {
    ...
    {
      Application::MessagingSystem::Send("TargetOne clicked", true);
    }
  }
...
static TargetOneScript TargetOne;
