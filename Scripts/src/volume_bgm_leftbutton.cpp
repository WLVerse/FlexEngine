...
// bgmvolumedecrease.cpp
//
// This script handles the interactions for the mouse inputs used by the left
// arrow of the background music slider. It decreases the volume each time the
...
class BGMDecreaseScript : public IScript
{
private:
  float timer = 0.f;
  bool to_spam = false;
...
static BGMDecreaseScript DecreaseBGM;
