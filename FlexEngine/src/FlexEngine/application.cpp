  ...
  void Application::ProcessCommands()
  {
    while (!m_command_queue.empty())
    {
      ...
      case Command::Application_AddLayer:
        ...
        _FLX_CMD_WARN(cmd.window_props != WindowProps::Null, "Application_AddLayer", "window properties");
      ...
      case Command::Application_AddOverlay:
        ...
        _FLX_CMD_WARN(cmd.window_props != WindowProps::Null, "Application_AddOverlay", "window properties");
      ...
      case Command::Application_RemoveLayer:
        ...
        _FLX_CMD_WARN(cmd.window_props != WindowProps::Null, "Application_RemoveLayer", "window properties");
      ...
      case Command::Application_RemoveOverlay:
        ...
        _FLX_CMD_WARN(cmd.window_props != WindowProps::Null, "Application_RemoveOverlay", "window properties");
      ...
      case Command::Application_ClearLayerStack:
        ...
        _FLX_CMD_WARN(cmd.window_props != WindowProps::Null, "Application_ClearLayerStack", "window properties");
        Application::GetLayerStack().Clear();
        break;
