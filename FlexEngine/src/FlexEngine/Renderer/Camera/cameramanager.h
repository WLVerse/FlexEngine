...
//        //TODO Change to RAII Manager , cameras should be a static vector (go through all available cameras to find) / unordered map (enter in entity id) 
//         // -? need to ask who controls which determines camera to be active (camera Manager waiting for signal from editor/game or self determine)
//    {
//        static std::unordered_map<FlexECS::EntityID, Camera> m_cameraEntities; /*!< Maps entity IDs to CameraData */
