...
namespace Editor
{
  ...
  ****************/
  ...
  COMPONENT_VIEWER_DRAG_INT(kernelSize)
  COMPONENT_VIEWER_DRAG_FLOAT(sigma)
  ...
  COMPONENT_VIEWER_DRAG_FLOAT(maxOffset)
  COMPONENT_VIEWER_DRAG_FLOAT(redOffset)
  COMPONENT_VIEWER_DRAG_FLOAT(greenOffset)
  COMPONENT_VIEWER_DRAG_FLOAT(blueOffset)
  ...
  COMPONENT_VIEWER_DRAG_FLOAT(intensity)
  COMPONENT_VIEWER_DRAG_FLOAT(radius)
  COMPONENT_VIEWER_DRAG_FLOAT(softness)
